...
<body>
      ...
      <div class="h-top" id="home">
		   <div class="top-header">
				  ...
				  <?php if(!isset($_SESSION['first'])){
					  ...
					  echo '<li><a class="active" href="myposts.php" data-hover="my posts">my posts</a></li>';
					?>
	
						<li><a  href="write.php" data-hover="write an interview">write an interview</a></li>
	...
	<div class="col-md-9 main">
		...
		<?php
			...
			$all_post = mysqli_query($conn,"SELECT * FROM post where name = '$namesession'  ORDER BY post_id DESC");
						...
						<div class="form-group">
							<div class="" style="">
								<div class="input-group " style="margin:10px 10px 4px 0px;" >
								  ...
								  <input type="text" placeholder="seeked postion" class="form-control" name="position" />
								</div>
